                                ...
                                {watchSlides.map((slide, index) => (
                                    <button
                                        ...
                                        className={`h-2 w-2 rounded-full transition ${
                                            (isCheckout ? checkoutSlideIndex : activeSlide) ===
                                            index
                                                ? "bg-blue-500"
                                                : "bg-gray-300"
                                        }`}
                                ...
                                <>
                                    ...
                                    <div className="space-y-6 border-t border-gray-100 pt-6 text-base text-gray-400">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <p>
                                                8mm Silver Aluminum Case with Blue Sport Band.
                                                Its perfect fit for tracking fitness. 100%
                                                waterproof. Buy this limited edition sports
                                                edition.
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div className="grid gap-6 sm:grid-cols-[1.1fr_0.7fr_0.7fr]">
                                            ...
                                            <div>
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        const currentIndex =
                                                            sizeOptions.indexOf(selectedSize);
                                                        const nextIndex =
